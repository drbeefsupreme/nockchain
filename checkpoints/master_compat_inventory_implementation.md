...
- [ ] M003 PMA dependencies are explicit inventory candidates (`--pma-persist`, `NOCK_PMA_*`, and `NOCK_STREAMING_CHECKPOINT_CHUNK_SIZE`).
...
- [ ] M007 Optional branch-only behavior is biased toward `remove` unless a stronger rationale is documented.
