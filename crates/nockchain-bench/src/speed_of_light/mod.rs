...
pub use harness::{
    ...
    expand_matrix, parse_matrix_value, resolve_requested_case, run_validation_probe, AxisValue,
    CpuProfileArtifact, CpuProfileExecutionKind, CpuProfilerConfig, CpuProfilerKind,
    DockerResolvedConfig, ExecuteOptions, ExecutionConfig, ExecutionRequest, ExpandedCase,
    HarnessSweepExecutor, RequestedCase, ResolvedCase, RunFailure, RunMetrics, RunSummary,
    RunSummaryInput, ScheduleMode, SweepComparison, SweepMatrix, SweepMatrixFile, SweepResult,
    SweepRunOptions, SweepSchedule, Validity, ValueStats, Verdict, WorkDirMode,
};
