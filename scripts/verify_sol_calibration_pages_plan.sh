...
CHECKLIST="${1:-checkpoints/sol_calibration_pages_implementation.md}"
...
unchecked="$(rg -n "^- \\[ \\] P[0-9]{3}\\b" "$CHECKLIST" || true)"
if [[ -n "$unchecked" ]]; then
...
echo "SOL calibration/pages checklist complete: $CHECKLIST"
