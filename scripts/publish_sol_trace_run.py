...
<body>
  <main>
    ...
    <section class="card">
      ...
      <p class="muted" style="margin-top:8px;"><strong>Reliability curve</strong>: we bucket predictions (for example 0.1-wide bins), then compare average predicted probability to actual positive rate in each bin. Perfect calibration sits on the diagonal. <strong>ECE</strong> is the weighted average vertical gap between that curve and the diagonal.</p>
